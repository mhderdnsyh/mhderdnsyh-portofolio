  ...
  const communities = [
    {
      ...
      period: "Jul – Aug 2023",
      documentationImages: [
        "/images/documentation-project-website-lipat-kain-utara.png",
        "/images/documentation-kkn-banner.png",
        "/images/documentation-kkn-lanyard.png",
        "/images/documentation-kkn-nametag-front.png",
        "/images/documentation-kkn-nametag-behind.png",
        "/images/documentation-kkn-template-live-report.png",
      ],
    ...
    },
    {
      ...
      period: "Jan – Dec 2023",
      documentationImages: [
        "/images/documentation-infokom-himatif-design.png",
        "/images/documentation-infokom-himatif-design-2.png",
        "/images/documentation-infokom-himatif-design-3.png",
        "/images/documentation-infokom-himatif-design-4.png",
        "/images/documentation-infokom-himatif-design-5.png",
        "/images/documentation-infokom-himatif-design-6.png",
      ],
                            ...
                            <div className="flex items-center gap-2">
                              {cert.credentialUrl && cert.credentialUrl !== "#" && (
                                <a
                                  ...
                                  className="text-xs font-medium text-zinc-300 hover:text-white border border-white/10 hover:bg-white/10 px-3 py-1 rounded-full transition-all whitespace-nowrap"
                                >
                                  View Image
                                </a>
                              )}
                              {cert.verificationUrl && cert.verificationUrl !== "#" && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="text-xs font-medium text-cyan-400 hover:text-cyan-300 border border-cyan-500/30 hover:bg-cyan-500/10 px-3 py-1 rounded-full transition-all whitespace-nowrap flex items-center gap-1.5"
                                >
